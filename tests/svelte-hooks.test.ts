...
describe("Svelte hook exports", () => {
  ...
  it("useCompletion getter/setter pattern works", async () => {
    const { useCompletion } = await import("../src/frameworks/svelte/use-completion.js");
  ...
  it("useObject getter pattern works", async () => {
    const { useObject } = await import("../src/frameworks/svelte/use-object.js");
